...
n.lin.grp$Category <- ifelse(n.lin.grp$`Pango Lineage` %in% c("B.1.1.7",
              ...
              "B.1.617", "B.1.617.1", "B.1.617", "B.1.618"), "VoI", ""))
...
\
A graphic depicting the relative frequency of Pango lineages assists in revealing the identities of the most frequent lineage designations assigned to PHO samples. Note that the samples numbers displayed below reflect recent Ontario sequences that have been processed on or after January 1, 2021.
\
...
# placeholder
```
## Sequence categorization by epi week
\
An overview of the Pango lineage categories for this figure can be found in the Technical Notes section. 
\
```{r, include=FALSE}
...
voi_sep <- "P.2, P.3, B.1.525, R.1, B.1.1.318, B.1.427, B.1.429, B.1.526, B.1.617, B.1.617.1,B.1.618, B.1.2 with S:E484K"
...
A lis tof the current Pango lineages that are classified as a VoC by PHO can be found in the Technical Notes section. 
\
...
\
A list of the current Pango lineages that are classified as VoIs by PHO can be found in the Technical Notes section. 

```{r, include = FALSE, echo=FALSE}

voi_list <- c("P.2", "P.3", "B.1.525", "R.1", "B.1.1.318", "B.1.427", "B.1.429", "B.1.526",
              "B.1.617", "B.1.617.1", "B.1.618")
...
lineages <- c("B.1.1.7", "B.1.351", "P.1", "P.2", "P.3", "B.1.525", "R.1", "B.1.1.318", "B.1.427", "B.1.429", "B.1.526", "B.1.526.1", "B.1.617", "B.1.617.1", "B.1.618")
